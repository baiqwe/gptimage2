...
type LoginSearchParams = Message & { next?: string };

export default async function Login(props: { searchParams: Promise<LoginSearchParams>; params: Promise<{ locale: string }> }) {
